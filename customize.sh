...
preserve_existing_config "mihomoData/app_blacklist.list"
preserve_existing_config "mihomoData/app_whitelist.list"
...
set_perm $MODPATH/bin/AppOpt-ebpf 0 0 0755
...
set_perm $MODPATH/scripts/usb.sh 0 0 0755
...
set_perm $MODPATH/smartdnsData/lib/libcrypto.so.* 0 0 0755
set_perm $MODPATH/smartdnsData/lib/libgcc_s.so.* 0 0 0755
set_perm $MODPATH/smartdnsData/lib/libssl.so.* 0 0 0755
